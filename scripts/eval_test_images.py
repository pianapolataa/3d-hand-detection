...
# MODEL_PATH = 'checkpoints/best_point_model_newest.pth'
# IMAGE_FOLDER = 'eval_images' # Ensure this folder exists
# IMG_SIZE = 224

# # 2. Skeletal Connection Mapping (MANO Standard)
# SKEL_CONNECTIONS = [
#     [0, 1, 2, 3, 4],    # Thumb
#     [0, 5, 6, 7, 8],    # Index
#     [0, 9, 10, 11, 12],  # Middle
...
# # This MUST match your training normalization exactly
...
# else:
#     print(f"🖼️ Found {len(image_files)} images. Starting loop...")
...
#     # Set view to match the image coordinate space
#     ax2.view_init(elev=-90, azim=-90)
    
#     # Keep the plot limits consistent (centered at wrist 0,0,0)
#     limit = 0.5
#     # ax2.set_xlim(-limit, limit); ax2.set_ylim(-limit, limit); ax2.set_zlim(-limit, limit)
#     ax2.legend(loc='upper right')
    
#     plt.tight_layout()
#     plt.show() # Close the window to proceed to the next image
